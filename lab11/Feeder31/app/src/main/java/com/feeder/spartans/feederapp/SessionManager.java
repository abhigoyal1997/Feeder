...
public class SessionManager {
    ...
    public static final String COURSES = null;
    ...
    public void createDatabase(String course_list)
    {
        editor.putString(COURSES,course_list);
        editor.commit();
    }
    ...
    {
        String database =  pref.getString(COURSES, null);
        return database;
    }
